...
namespace APP_LAWYER.DAL.Migrations
{
    ...
    [Migration("20230627183651_AddedUsers")]
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ceb53a24-818d-4b6b-b506-952ea0cdb488"),
                        ...
                        new
                        {
                            Id = new Guid("01468c10-0d2c-4ed8-b540-d9d9e991be1c"),
                        ...
                        new
                        {
                            Id = new Guid("6c8f8cf6-73d0-4260-ae15-a097b531c97a"),
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Subcategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("28d21181-3562-4c1d-b8c3-669ad46627b4"),
                            CategoryId = new Guid("ceb53a24-818d-4b6b-b506-952ea0cdb488"),
                        ...
                        new
                        {
                            Id = new Guid("51bd5e75-7478-410b-b29e-533d72fa12d1"),
                            CategoryId = new Guid("ceb53a24-818d-4b6b-b506-952ea0cdb488"),
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.SubcategoryVideo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubcategoryId = new Guid("28d21181-3562-4c1d-b8c3-669ad46627b4"),
                            VideoId = new Guid("2966b001-a27c-4e11-92a5-1bad3279dc19")
                        },
                        new
                        {
                            SubcategoryId = new Guid("51bd5e75-7478-410b-b29e-533d72fa12d1"),
                            VideoId = new Guid("1fe20516-3551-41b6-9f16-b693a75a0c51")
                        },
                        new
                        {
                            SubcategoryId = new Guid("51bd5e75-7478-410b-b29e-533d72fa12d1"),
                            VideoId = new Guid("0e69f200-77c3-48a8-ab9a-2bb1a3d54f2a")
                        });
                });
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Video", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2966b001-a27c-4e11-92a5-1bad3279dc19"),
                        ...
                        new
                        {
                            Id = new Guid("1fe20516-3551-41b6-9f16-b693a75a0c51"),
                            Description = "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>",
                        ...
                        new
                        {
                            Id = new Guid("0e69f200-77c3-48a8-ab9a-2bb1a3d54f2a"),
                            Description = "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>",
