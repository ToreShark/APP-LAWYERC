...
{
    /// <inheritdoc />
    public partial class AddedTitleVideo : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0a072b8b-e8f0-46ff-b83f-626a01808cd7"), 2 },
                    { new Guid("372600bc-d87d-4647-88c8-80104478c669"), 4 },
                    { new Guid("9c26d286-22e9-4eda-b978-1766f63ebff0"), 3 },
                    { new Guid("e837a0bc-261b-43d5-b192-b98a720ab1b1"), 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1d7b8a4b-445b-4b14-9b75-7ca6d16d1c8f"), "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>", "Причинение смерти по неосторожности правонарушение1 movie", "https://youtu.be/AmUenqhE1mw" },
                    { new Guid("4e91b3ca-7ff9-47d3-91b7-8e3697558363"), "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>", "Причинение смерти по неосторожности правонарушение2 movie", "https://youtu.be/AmUenqhE1mw" },
                    { new Guid("fe36dbee-6766-4c36-a521-a33823b84eb5"), "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>", "Описание состава убийства movie", "https://youtu.be/AmUenqhE1mw" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("17aa4902-f28e-4edb-a19d-e71ac3f65e53"), new Guid("1d7b8a4b-445b-4b14-9b75-7ca6d16d1c8f") },
                    { new Guid("17aa4902-f28e-4edb-a19d-e71ac3f65e53"), new Guid("4e91b3ca-7ff9-47d3-91b7-8e3697558363") },
                    { new Guid("83dd56e6-012f-4349-a5e7-053e37d0bdce"), new Guid("fe36dbee-6766-4c36-a521-a33823b84eb5") }
                });
