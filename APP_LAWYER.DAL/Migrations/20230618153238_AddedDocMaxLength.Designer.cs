...
namespace APP_LAWYER.DAL.Migrations
{
    ...
    [Migration("20230618153238_AddedDocMaxLength")]
    partial class AddedDocMaxLength
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7015faa7-efe2-44e4-be44-b64f019e3938"),
                        ...
                        new
                        {
                            Id = new Guid("b923fed6-c29b-49bb-96bf-01b3031e7313"),
                        ...
                        new
                        {
                            Id = new Guid("5ceb858c-c1ec-49d6-97a5-5d293a706147"),
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Subcategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0dba380e-a53f-43c2-b200-347f9c87a986"),
                            CategoryId = new Guid("7015faa7-efe2-44e4-be44-b64f019e3938"),
                        ...
                        new
                        {
                            Id = new Guid("e1079667-8828-4de6-9844-2f61d98aab5b"),
                            CategoryId = new Guid("7015faa7-efe2-44e4-be44-b64f019e3938"),
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.SubcategoryVideo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubcategoryId = new Guid("0dba380e-a53f-43c2-b200-347f9c87a986"),
                            VideoId = new Guid("2a1440a2-7b40-464b-93ef-d298690c94ab")
                        },
                        new
                        {
                            SubcategoryId = new Guid("e1079667-8828-4de6-9844-2f61d98aab5b"),
                            VideoId = new Guid("3da066cb-3119-4368-80eb-3aee7969cd79")
                        },
                        new
                        {
                            SubcategoryId = new Guid("e1079667-8828-4de6-9844-2f61d98aab5b"),
                            VideoId = new Guid("bf5f9c51-6486-460c-aabe-ea3a5657b545")
                        });
                });
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Video", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2a1440a2-7b40-464b-93ef-d298690c94ab"),
                        ...
                        new
                        {
                            Id = new Guid("3da066cb-3119-4368-80eb-3aee7969cd79"),
                            Description = "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>",
                        ...
                        new
                        {
                            Id = new Guid("bf5f9c51-6486-460c-aabe-ea3a5657b545"),
                            Description = "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>",
