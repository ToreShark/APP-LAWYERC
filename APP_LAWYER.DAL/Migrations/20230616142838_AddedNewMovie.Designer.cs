...
namespace APP_LAWYER.DAL.Migrations
{
    ...
    [Migration("20230616142838_AddedNewMovie")]
    partial class AddedNewMovie
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("dd3b6c3c-86c8-49d7-ac1d-d2498e55c2bf"),
                        ...
                        new
                        {
                            Id = new Guid("30685eeb-e189-4e22-97b9-8889869b2191"),
                        ...
                        new
                        {
                            Id = new Guid("c0654789-ae49-489c-ae7a-299f2eb76327"),
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Subcategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4d4f5764-6a18-43e5-b4a0-4638ff3db116"),
                            CategoryId = new Guid("dd3b6c3c-86c8-49d7-ac1d-d2498e55c2bf"),
                        ...
                        new
                        {
                            Id = new Guid("2f9849c1-1fd2-4e60-b4fe-e303aa50ea33"),
                            CategoryId = new Guid("dd3b6c3c-86c8-49d7-ac1d-d2498e55c2bf"),
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.SubcategoryVideo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubcategoryId = new Guid("4d4f5764-6a18-43e5-b4a0-4638ff3db116"),
                            VideoId = new Guid("c6397ad6-7281-4570-9870-7185c9f77c40")
                        },
                        new
                        {
                            SubcategoryId = new Guid("2f9849c1-1fd2-4e60-b4fe-e303aa50ea33"),
                            VideoId = new Guid("c83e8eee-2c67-4f5a-9584-df14142b4fdf")
                        },
                        new
                        {
                            SubcategoryId = new Guid("2f9849c1-1fd2-4e60-b4fe-e303aa50ea33"),
                            VideoId = new Guid("1ae47e74-25b5-4345-ae1c-ec2b5bf83e29")
                        });
                });
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Video", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c6397ad6-7281-4570-9870-7185c9f77c40"),
                        ...
                        new
                        {
                            Id = new Guid("c83e8eee-2c67-4f5a-9584-df14142b4fdf"),
                            Description = "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>",
                        ...
                        new
                        {
                            Id = new Guid("1ae47e74-25b5-4345-ae1c-ec2b5bf83e29"),
                            Description = "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>",
