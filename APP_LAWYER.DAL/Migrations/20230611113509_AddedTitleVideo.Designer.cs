...
namespace APP_LAWYER.DAL.Migrations
{
    ...
    [Migration("20230611113509_AddedTitleVideo")]
    partial class AddedTitleVideo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1bf1e6fb-0b25-41a6-9431-a2e3836dcdb6"),
                        ...
                        new
                        {
                            Id = new Guid("b1fd7b0e-2a90-4be4-a455-38dec0da54b4"),
                        ...
                        new
                        {
                            Id = new Guid("ec41bfe4-3dc9-404f-9cfe-fabcae0f6471"),
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e837a0bc-261b-43d5-b192-b98a720ab1b1"),
                            RoleName = 1
                        },
                        new
                        {
                            Id = new Guid("0a072b8b-e8f0-46ff-b83f-626a01808cd7"),
                            RoleName = 2
                        },
                        new
                        {
                            Id = new Guid("9c26d286-22e9-4eda-b978-1766f63ebff0"),
                            RoleName = 3
                        },
                        new
                        {
                            Id = new Guid("372600bc-d87d-4647-88c8-80104478c669"),
                            RoleName = 4
                        });
                });
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Subcategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("83dd56e6-012f-4349-a5e7-053e37d0bdce"),
                            CategoryId = new Guid("1bf1e6fb-0b25-41a6-9431-a2e3836dcdb6"),
                        ...
                        new
                        {
                            Id = new Guid("17aa4902-f28e-4edb-a19d-e71ac3f65e53"),
                            CategoryId = new Guid("1bf1e6fb-0b25-41a6-9431-a2e3836dcdb6"),
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.SubcategoryVideo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubcategoryId = new Guid("83dd56e6-012f-4349-a5e7-053e37d0bdce"),
                            VideoId = new Guid("fe36dbee-6766-4c36-a521-a33823b84eb5")
                        },
                        new
                        {
                            SubcategoryId = new Guid("17aa4902-f28e-4edb-a19d-e71ac3f65e53"),
                            VideoId = new Guid("1d7b8a4b-445b-4b14-9b75-7ca6d16d1c8f")
                        },
                        new
                        {
                            SubcategoryId = new Guid("17aa4902-f28e-4edb-a19d-e71ac3f65e53"),
                            VideoId = new Guid("4e91b3ca-7ff9-47d3-91b7-8e3697558363")
                        });
                });
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Video", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fe36dbee-6766-4c36-a521-a33823b84eb5"),
                        ...
                        new
                        {
                            Id = new Guid("1d7b8a4b-445b-4b14-9b75-7ca6d16d1c8f"),
                            Description = "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>",
                        ...
                        new
                        {
                            Id = new Guid("4e91b3ca-7ff9-47d3-91b7-8e3697558363"),
                            Description = "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>",
