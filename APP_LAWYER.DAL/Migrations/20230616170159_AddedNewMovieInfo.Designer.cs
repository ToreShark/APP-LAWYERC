...
namespace APP_LAWYER.DAL.Migrations
{
    ...
    [Migration("20230616170159_AddedNewMovieInfo")]
    partial class AddedNewMovieInfo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d37ea7c2-2671-4b22-afd7-47d336ee18b8"),
                        ...
                        new
                        {
                            Id = new Guid("c31c48fb-dd15-436b-bbc6-cd32d772c07c"),
                        ...
                        new
                        {
                            Id = new Guid("ab153c83-0074-4699-83c4-898bdf7f8f55"),
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Subcategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9758ccf3-48b3-4c94-94c8-c73eb3de0516"),
                            CategoryId = new Guid("d37ea7c2-2671-4b22-afd7-47d336ee18b8"),
                        ...
                        new
                        {
                            Id = new Guid("17fd3d94-1a8c-4674-9c5f-faabd70e3294"),
                            CategoryId = new Guid("d37ea7c2-2671-4b22-afd7-47d336ee18b8"),
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.SubcategoryVideo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubcategoryId = new Guid("9758ccf3-48b3-4c94-94c8-c73eb3de0516"),
                            VideoId = new Guid("b1bbdfe6-fc61-4eb2-ad87-64849209e4f9")
                        },
                        new
                        {
                            SubcategoryId = new Guid("17fd3d94-1a8c-4674-9c5f-faabd70e3294"),
                            VideoId = new Guid("fcf36356-9a18-41d9-b837-ae44af63add7")
                        },
                        new
                        {
                            SubcategoryId = new Guid("17fd3d94-1a8c-4674-9c5f-faabd70e3294"),
                            VideoId = new Guid("6f939a4d-51de-466c-8daa-5d7c7b1e9a3e")
                        });
                });
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Video", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b1bbdfe6-fc61-4eb2-ad87-64849209e4f9"),
                        ...
                        new
                        {
                            Id = new Guid("fcf36356-9a18-41d9-b837-ae44af63add7"),
                            Description = "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>",
                        ...
                        new
                        {
                            Id = new Guid("6f939a4d-51de-466c-8daa-5d7c7b1e9a3e"),
                            Description = "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>",
