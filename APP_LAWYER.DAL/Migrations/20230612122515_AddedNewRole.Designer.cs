...
namespace APP_LAWYER.DAL.Migrations
{
    ...
    [Migration("20230612122515_AddedNewRole")]
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a7949e00-693b-4335-9754-2676d49cb928"),
                        ...
                        new
                        {
                            Id = new Guid("cfa98544-3155-4e07-b8f8-361ea29fe9e5"),
                        ...
                        new
                        {
                            Id = new Guid("5b615615-0fdf-46ee-830b-5b1094c91624"),
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Subcategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d69059ff-1a8c-48b6-b93d-d9bfd1e34658"),
                            CategoryId = new Guid("a7949e00-693b-4335-9754-2676d49cb928"),
                        ...
                        new
                        {
                            Id = new Guid("41207b94-fb73-4105-8eb3-721107f73d7e"),
                            CategoryId = new Guid("a7949e00-693b-4335-9754-2676d49cb928"),
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.SubcategoryVideo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubcategoryId = new Guid("d69059ff-1a8c-48b6-b93d-d9bfd1e34658"),
                            VideoId = new Guid("7c546014-7845-40f0-9867-7750b1e73bed")
                        },
                        new
                        {
                            SubcategoryId = new Guid("41207b94-fb73-4105-8eb3-721107f73d7e"),
                            VideoId = new Guid("a1e134c9-39b8-454b-8a61-761631c925a0")
                        },
                        new
                        {
                            SubcategoryId = new Guid("41207b94-fb73-4105-8eb3-721107f73d7e"),
                            VideoId = new Guid("83bec600-34c2-4411-83dd-d54aa5126a87")
                        });
                });
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Video", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7c546014-7845-40f0-9867-7750b1e73bed"),
                        ...
                        new
                        {
                            Id = new Guid("a1e134c9-39b8-454b-8a61-761631c925a0"),
                            Description = "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>",
                        ...
                        new
                        {
                            Id = new Guid("83bec600-34c2-4411-83dd-d54aa5126a87"),
                            Description = "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>",
