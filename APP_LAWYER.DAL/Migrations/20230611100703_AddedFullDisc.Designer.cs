...
namespace APP_LAWYER.DAL.Migrations
{
    ...
    [Migration("20230611100703_AddedFullDisc")]
    partial class AddedFullDisc
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("936607c6-f133-4438-9fe4-01e00126c44b"),
                        ...
                        new
                        {
                            Id = new Guid("2fa459c8-b31d-419a-a54a-81c8ce307060"),
                        ...
                        new
                        {
                            Id = new Guid("fd60015b-bcb2-4f33-b7df-b05a4553f718"),
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2e662c3a-a4e9-4b0f-91c8-7ead57d734e3"),
                            RoleName = 1
                        },
                        new
                        {
                            Id = new Guid("a5cbc163-3883-4e5b-b13f-e943db8564e1"),
                            RoleName = 2
                        },
                        new
                        {
                            Id = new Guid("5f64ab19-eedc-4929-8045-2776c44c15b4"),
                            RoleName = 3
                        },
                        new
                        {
                            Id = new Guid("ab4e8150-2a05-4e46-8f30-73bbe9982759"),
                            RoleName = 4
                        });
                });
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Subcategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("33b0246e-735c-48d6-8ef5-6555e06e9df5"),
                            CategoryId = new Guid("936607c6-f133-4438-9fe4-01e00126c44b"),
                        ...
                        new
                        {
                            Id = new Guid("9e1f8c5f-68c5-465b-8894-e4972c2f0f3a"),
                            CategoryId = new Guid("936607c6-f133-4438-9fe4-01e00126c44b"),
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.SubcategoryVideo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubcategoryId = new Guid("33b0246e-735c-48d6-8ef5-6555e06e9df5"),
                            VideoId = new Guid("9e21cb57-366b-4a7e-a711-7bea229d6737")
                        },
                        new
                        {
                            SubcategoryId = new Guid("9e1f8c5f-68c5-465b-8894-e4972c2f0f3a"),
                            VideoId = new Guid("b80f8df2-3e91-4e7f-ba51-ef64f7bbed1b")
                        },
                        new
                        {
                            SubcategoryId = new Guid("9e1f8c5f-68c5-465b-8894-e4972c2f0f3a"),
                            VideoId = new Guid("48924b4c-1112-4438-9956-61ed8047147a")
                        });
                });
            ...
            modelBuilder.Entity("APP_LAWYER.DAL.Entities.Video", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9e21cb57-366b-4a7e-a711-7bea229d6737"),
                        ...
                        new
                        {
                            Id = new Guid("b80f8df2-3e91-4e7f-ba51-ef64f7bbed1b"),
                            Description = "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>",
                            Url = "https://youtu.be/AmUenqhE1mw"
                        },
                        new
                        {
                            Id = new Guid("48924b4c-1112-4438-9956-61ed8047147a"),
                            Description = "<div class='App' style='text-align: center;'><h1>Заявление</h1><p>от [name]</p><p>для [nameFor]</p><p><a href='https://github.com/remarkablemark/html-react-parser' target='_blank' rel='noopener noreferrer'>View GitHub repository</a></p><hr class='remove'></div>",
                            Url = "https://youtu.be/AmUenqhE1mw"
                        });
                });
